...
url = "http://localhost:4343/oapi/processes/wis2box-csv2bufr/execution"
...
expected_response = {
  ...
  "errors": [],
  "warnings": [
    "#1#pressureReducedToMeanSeaLevel: Value (10104.0) out of valid range (50000 - 150000).; Element set to missing" # noqa
  ]
}
